...
Affairs = pd.read_csv("C:/Users/personal/Desktop/Affairs.csv")
...
optimal_threshold # 0.252157157013533
...
roc_auc = metrics.auc(fpr, tpr)  #AUC = 0.7208
roc_auc
